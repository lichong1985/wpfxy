    ...
    export class LiangXiongDiBuKaiQiangJZ extends JuZiGuanLi {
        ...
        public init1ZTJ() {
            ...
            this.fc1 = new feichuan.JuZhenJidui(this.scene, this.fc_info1,
                egret.Point.create(-5, 45), this.nan_du);
        ...
        public init2ZTJ() {
            ...
            this.fc2 = new feichuan.JuZhenJidui(this.scene, this.fc_info2,
                egret.Point.create(32, 8), this.nan_du);
            ...
            ztj.addInfo(new zhuangtaiji.ZhuangTaiJiInfoBean(egret.Point.create(3, 8),
                zhuangtaiji.ZT_TYPE.JIAN_SI_MOVE_ING, zhuangtaiji.ZT_TYPE.YUN_DONG_DAO_HANG_ING, zhuangtaiji.ZT_TYPE.NULL_T, 8, 2, null, 2, -1, "13:15"));
            //2
            ztj.addInfo(new zhuangtaiji.ZhuangTaiJiInfoBean(egret.Point.create(26, 38),
                zhuangtaiji.ZT_TYPE.JIAN_SI_MOVE_ING, zhuangtaiji.ZT_TYPE.YUN_DONG_DAO_HANG_ING, zhuangtaiji.ZT_TYPE.NULL_T, 8, 2, null, 2, -1, "32:52"));
            //3
