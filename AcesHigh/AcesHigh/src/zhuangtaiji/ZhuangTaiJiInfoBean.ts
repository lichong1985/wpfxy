module zhuangtaiji {
    export class ZhuangTaiJiInfoBean {
        ...
        constructor(pos: egret.Point, mT: zhuangtaiji.ZT_TYPE, mZ: zhuangtaiji.ZT_TYPE, gjT: zhuangtaiji.ZT_TYPE, mT_xs: number, mZ_xs: number, gjT_xs: WuQiAiInfo, move_time: number, sleep_time: number, mb: string) {
