...
(function (juzi) {
    var SanXiongDiManDongJZ = (function (_super) {
        ...
        SanXiongDiManDongJZ.prototype.init1ZTJ = function () {
            ...
            //移动
            ztj.addInfo(new zhuangtaiji.ZhuangTaiJiInfoBean(egret.Point.create(17, 8), zhuangtaiji.ZT_TYPE.JIAN_SI_MOVE_ING, zhuangtaiji.ZT_TYPE.MIAO_ZHUN_SK, zhuangtaiji.ZT_TYPE.PU_TONG_WU_QI_ING, 1, 1, [new zhuangtaiji.WuQiAiInfo(100, 10000, 1, 10000, 5, 1)], 2, -1, "13:15"));
            //休息
        ...
        SanXiongDiManDongJZ.prototype.init2ZTJ = function () {
            ...
            //移动
            ztj.addInfo(new zhuangtaiji.ZhuangTaiJiInfoBean(egret.Point.create(3, 8), zhuangtaiji.ZT_TYPE.JIAN_SI_MOVE_ING, zhuangtaiji.ZT_TYPE.MIAO_ZHUN_SK, zhuangtaiji.ZT_TYPE.PU_TONG_WU_QI_ING, 1, 1, [new zhuangtaiji.WuQiAiInfo(100, 5000, 1, 100, 5, 1)], 2, -1, "3:8"));
            //休息
        ...
        SanXiongDiManDongJZ.prototype.init3ZTJ = function () {
            ...
            //移动
            ztj.addInfo(new zhuangtaiji.ZhuangTaiJiInfoBean(egret.Point.create(28, 15), zhuangtaiji.ZT_TYPE.JIAN_SI_MOVE_ING, zhuangtaiji.ZT_TYPE.MIAO_ZHUN_SK, zhuangtaiji.ZT_TYPE.PU_TONG_WU_QI_ING, 1, 1, [new zhuangtaiji.WuQiAiInfo(100, 10000, 1, 10000, 5, 1)], 2, -1, "13:15"));
            //休息
